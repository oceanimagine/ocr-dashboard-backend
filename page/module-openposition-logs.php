...
<div class="row">
    ...
    <div class="col-sm-4">
        <input onkeyup="cari(this.value);" type="text" class="form-control" placeholder="Cari Open Position Detail Logs" name="cari_open_position_detail" id="cari_open_position" value="<?php echo $s; ?>">
    </div> 
</div>
<br />
...
function cari(string_search){
    ...
    xmlhttp.onreadystatechange = function(){
        if(this.readyState === 4 && this.status === 200){
            var hasil_op_logs = document.getElementById("hasil_op_logs");
            hasil_op_logs.innerHTML = this.responseText;
            load_td();
        }
    };
    xmlhttp.open("GET","ajax/get_open_position_logs.php?id=<?php echo $id; ?>&q=" + encodeURI(string_search));
    xmlhttp.send(null);
}
